...
const Footer = () => {
  return (
    <footer id="contect" className="flexCenter mb-24">
      <div className="max-container padding-container w-full flex flex-col gap-14">
              ...
              <FooterColomn title={FOOTER_CONTACT_INFO.title}>
                {FOOTER_CONTACT_INFO.links.map((item) => (
                  ...
                  >
                    ...
                    <p className="medium-14 whitespace-nowrap pt-[2px] text-blue-70">
                      {item.value}
                    </p>
                  </Link>
                ))}
        ...
        <p className="regular-14 text-center w-full text-gray-30">All right Reserved</p>
      </div>
    </footer>
  );
};
